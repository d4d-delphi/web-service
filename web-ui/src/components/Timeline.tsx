    ...
    <div className="bg-[#0d1117] border-t border-gray-800 px-4 py-2">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="w-7 h-7 flex items-center justify-center rounded bg-gray-800 border border-gray-700 hover:border-gray-500 transition-all"
        >
          {isPlaying ? (
        ...
        <div className="flex gap-1">
          {phases.map((phase) => (
            <button
              ...
              className={`px-2 py-1 text-[9px] rounded border transition-all whitespace-nowrap ${
